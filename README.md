...
cd dcomex-framework
MAKEFLAGS=-j`nproc -all` PKG_CONFIG_PATH=/scratch/slitvinov/.grace/lib/pkgconfig:/scratch/slitvinov/.grace/share/pkgconfig:$PKG_CONFIG_PATH make lkorali 'USER = 0' 'CXXFLAGS_PYBIND11 =-I$(HOME)/.local/lib/python3.9/site-packages/pybind11/include'
```
